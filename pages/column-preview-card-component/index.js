                ...
                <div className={styles.cardHolder}>
                    <div className={styles.card}>
                        <div className={styles.cardHeader}>
                            <img src="/images/column-preview-card-component/illustration-hero.svg"/>
                        </div>
                            ...
                            <div className={styles.bodyPlanCard + " mt-4"}>
                                <div className="d-flex">
                                    <div className="col p-0 d-flex justify-content-start">
                                        <div className="col-auto pl-0"><img src="/images/column-preview-card-component/icon-music.svg"/></div>
