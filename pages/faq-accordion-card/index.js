    ...
    return (
        <Fragment>
            ...
            <div className={styles.background}>
                <img className={styles.img3 + " " + styles.displayDesktop} src="/images/faq-accordion-card/illustration-box-desktop.svg" />
                <div className={styles.cardHolder}>
                    <div className={styles.card}>
                        <div className="row m-0">
                            <div className={styles.imgHolderMobile}>
                                <img className={styles.img1Mobile + " " + styles.displayMobile} src="/images/faq-accordion-card/bg-pattern-desktop.svg" />
                                <img className={styles.img2Mobile + " " + styles.displayMobile} src="/images/faq-accordion-card/illustration-woman-online-desktop.svg" />
                                <img className={styles.img3Mobile + " " + styles.displayMobile} src="/images/faq-accordion-card/illustration-box-desktop.svg" />
                            </div>
                            <div className="col-md-6 col-12">
                                <div className={styles.imgHolder}>
                                    <img className={styles.img1 + " " + styles.displayDesktop} width="720" src="/images/faq-accordion-card/bg-pattern-desktop.svg" />
                                    <img className={styles.img2 + " " + styles.displayDesktop} width="720" src="/images/faq-accordion-card/illustration-woman-online-desktop.svg" />
