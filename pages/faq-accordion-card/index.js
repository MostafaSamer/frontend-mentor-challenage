                            ...
                            <div className="col-md-6 col-12">
                                ...
                                <div className={styles.bodyDropdownHolder + " row py-3 m-0"}>
                                    <div className={styles.bodyDropdown + " w-100"} onClick={() => { SelectedIndexQuestion == 0? SetSelectedIndexQuestion(-1) : SetSelectedIndexQuestion(0) }}>
                                        <div className={styles.bodyQuestion + " " + (SelectedIndexQuestion == 0? styles.bodyQuestionSelected : "") + " row"}>
                                        ...
                                        <div className={(SelectedIndexQuestion == 0? styles.bodyAnswerShow : styles.bodyAnswerHide)}>
                                ...
                                <div className={styles.bodyDropdownHolder + " row py-3 m-0"}>
                                    <div className={styles.bodyDropdown + " w-100"} onClick={() => { SelectedIndexQuestion == 1? SetSelectedIndexQuestion(-1) : SetSelectedIndexQuestion(1) }}>
                                        <div className={styles.bodyQuestion + " " + (SelectedIndexQuestion == 1? styles.bodyQuestionSelected : "") + " row"}>
                                        ...
                                        <div className={(SelectedIndexQuestion == 1? styles.bodyAnswerShow : styles.bodyAnswerHide)}>
                                            No more than 2GB. All files in your account must fit your
                                            allotted storage space.
                                        </div>
                                    </div>
                                ...
                                <div className={styles.bodyDropdownHolder + " row py-3 m-0"}>
                                    <div className={styles.bodyDropdown + " w-100"} onClick={() => { SelectedIndexQuestion == 2? SetSelectedIndexQuestion(-1) : SetSelectedIndexQuestion(2) }}>
                                        <div className={styles.bodyQuestion + " " + (SelectedIndexQuestion == 2? styles.bodyQuestionSelected : "") + " row"}>
                                        ...
                                        <div className={(SelectedIndexQuestion == 2? styles.bodyAnswerShow : styles.bodyAnswerHide)}>
                                            No more than 2GB. All files in your account must fit your
                                            allotted storage space.
                                        </div>
                                    </div>
                                ...
                                <div className={styles.bodyDropdownHolder + " row py-3 m-0"}>
                                    <div className={styles.bodyDropdown + " w-100"} onClick={() => { SelectedIndexQuestion == 3? SetSelectedIndexQuestion(-1) : SetSelectedIndexQuestion(3) }}>
                                        <div className={styles.bodyQuestion + " " + (SelectedIndexQuestion == 3? styles.bodyQuestionSelected : "") + " row"}>
                                        ...
                                        <div className={(SelectedIndexQuestion == 3? styles.bodyAnswerShow : styles.bodyAnswerHide)}>
                                            No more than 2GB. All files in your account must fit your
                                            allotted storage space.
                                        </div>
                                    </div>
                                ...
                                <div className={styles.bodyDropdownHolder + " row py-3 m-0"}>
                                    <div className={styles.bodyDropdown + " w-100"} onClick={() => { SelectedIndexQuestion == 4? SetSelectedIndexQuestion(-1) : SetSelectedIndexQuestion(4) }}>
                                        <div className={styles.bodyQuestion + " " + (SelectedIndexQuestion == 4? styles.bodyQuestionSelected : "") + " row"}>
                                        ...
                                        <div className={(SelectedIndexQuestion == 4? styles.bodyAnswerShow : styles.bodyAnswerHide)}>
                                            No more than 2GB. All files in your account must fit your
                                            allotted storage space.
                                        </div>
                                    </div>
                                ...
                                <div className={styles.bodyDropdownHolder + " row py-3 m-0"}>
                                    <div className={styles.bodyDropdown + " w-100"} onClick={() => { SelectedIndexQuestion == 5? SetSelectedIndexQuestion(-1) : SetSelectedIndexQuestion(5) }}>
                                        <div className={styles.bodyQuestion + " " + (SelectedIndexQuestion == 5? styles.bodyQuestionSelected : "") + " row"}>
                                            <div className="col-auto p-0">How many team member can I invite?</div>
                                            <div className={" col-auto p-0"}>
                                            <img className={(SelectedIndexQuestion == 5? styles.bodyQuestionArrowFiliped : "")} src="/images/faq-accordion-card/icon-arrow-down.svg"/>
                                            </div>
                                        </div>
                                        <div className={(SelectedIndexQuestion == 5? styles.bodyAnswerShow : styles.bodyAnswerHide)}>
                                            No more than 2GB. All files in your account must fit your
                                            allotted storage space.
                                        </div>
                                    </div>
